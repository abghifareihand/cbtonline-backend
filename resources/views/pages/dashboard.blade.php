    ...
    <div class="row">
        ...
        <div class="card border-0 zoom-in bg-info-subtle shadow-none">
          <div class="card-body">
            <div class="text-center">
              <img src="../assets/images/icons/icon-connect.svg" width="50" height="50" class="mb-3" alt="" />
      ...
      <div class="col-sm-6 col-xl-3">
        <div class="card border-0 zoom-in bg-success-subtle shadow-none">
          <div class="card-body">
            <div class="text-center">
              <img src="../assets/images/icons/icon-speech-bubble.svg" width="50" height="50" class="mb-3" alt="" />
              <p class="fw-semibold fs-3 text-success mb-1">Admin</p>
              <h5 class="fw-semibold text-success mb-0">15</h5>
            </div>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-xl-3">
        <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
          <div class="card-body">
            <div class="text-center">
              <img src="../assets/images/icons/icon-favorites.svg" width="50" height="50" class="mb-3" alt="" />
              <p class="fw-semibold fs-3 text-danger mb-1">User</p>
              <h5 class="fw-semibold text-danger mb-0">20</h5>
            </div>
          </div>
        </div>
      </div>
      <div class="col-sm-6 col-xl-3">
        <div class="card border-0 zoom-in bg-info-subtle shadow-none">
          <div class="card-body">
            <div class="text-center">
              <img src="../assets/images/icons/icon-mailbox.svg" width="50" height="50" class="mb-3" alt="" />
